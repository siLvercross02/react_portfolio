                        ...
                        <Card className="card-project">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://affinitycorp.net/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>                   
                    </Col>  
                        ...
                        <Card className="card-project">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://gpt3-demo.netlify.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>                   
                    </Col>  
                        ...
                        <Card className="card-project card-sm-adjust">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://clone-a6e07.web.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>
                    </Col>
                        ...
                        <Card className="card-project">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://netflix-clone-697b8.web.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>                   
                    </Col>  
                        ...
                        <Card className="card-project card-sm-adjust">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://klickvpn.netlify.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>
                    </Col>
                        ...
                        <Card className="card-project">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://communifi.netlify.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>                    
                    </Col>  
                        ...
                        <Card className="card-project card-sm-adjust">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://communitalk.netlify.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>
                    </Col>
                        ...
                        <Card className="card-project">
                            ...
                            <Card.ImgOverlay className="overlay-radius bg-secondary-custom">
                                <div className="text-center overlay-sm mt-5">
                                    ...
                                    <a href="https://klickstreamzones.netlify.app/" className="btn btn-info rounded-pill pl-5 pr-5" rel="noopener noreferrer" target="_blank">View Project</a>
                                </div>
                            </Card.ImgOverlay>
                        </Card>                   
                    </Col>  
